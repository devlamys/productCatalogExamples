...
export const PRODUCTS = [
  {
    id: "prod-x-ghee-tap",
    variantId: "variant-x",
    title: "Gawdee Pure A2 Desi Ghee",
    category: "Simple Tap Swap",
    ...
    codeSnippet: {
      css: `/* Variant X: Ghee Simple Tap-First Swap */\n.original-card { border: 1px solid rgba(0, 155, 123, 0.4); border-radius: 1.5rem; }\n.original-card-2 { background: #ffffff; border-radius: 1.5rem; }`,
      framer: `<img src="/images/Ghee/GheeFirst.jpeg" onMouseEnter={showSecond} onClick={toggleSwap} />`,
    },
  },
  {
    id: "prod-original-1",
    variantId: "variant-original-showcase",
    title: "Gawdee Original Organic Harvest Pack",
    category: "Original Gawdee Cards",
    brand: "Gawdee Organic Nutrition",
    brandLogo: BRAND.logo,
    brandColor: BRAND.primaryColor,
...
.original-card { border: 1px solid rgba(0, 155, 123, 0.4); border-radius: 1.5rem; }`,
      framer: `<motion.img src="/images/orginalimage/WhatsApp Image 2026-09-04 at 12.03.54 PM.jpeg" whileHover={{ scale: 1.06 }} />`,
    },
  },
  {
    id: "prod-original-2",
    variantId: "variant-original-showcase-2",
    title: "Gawdee Pure Botanical Organic Elixir",
    category: "Original Gawdee Cards",
    brand: "Gawdee Organic Nutrition",
    brandLogo: BRAND.logo,
    brandColor: BRAND.primaryColor,
...
.original-card-2 { background: #ffffff; border-radius: 1.5rem; }`,
      framer: `<motion.img src="/images/orginalimage/WhatsApp Image 2026-09-04 at 12.03.55 PM.jpeg" whileHover={{ scale: 1.06 }} />`,
    },
  },
  {
    id: "prod-ag-1",
    variantId: "variant-ag-1",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    swatches: [
      ...
      { name: "Apex Blue", colorHex: "#0066FF" },
      { name: "Neon Crimson", colorHex: "#FF3B30" },
    ...
    codeSnippet: {
      css: `/* Style 1: Monolith Drop Elevation */\n.monolith-drop { box-shadow: 0 45px 35px -10px rgba(0,0,0,0.85); }`,
      framer: `<motion.img animate={{ y: [-14, 4, -14] }} transition={{ duration: 3.5, repeat: Infinity }} />`,
    },
  },
  {
    id: "prod-ag-2",
    variantId: "variant-ag-2",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 2: Glare Tilt Perspective */\n.glare-card { transform-style: preserve-3d; }`,
      framer: `<motion.div style={{ rotateX, rotateY }} />`,
    },
  },
  {
    id: "prod-ag-3",
    variantId: "variant-ag-3",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 3: Orbital Swatches */\n.orbit-swatch { z-index: var(--depth); }`,
      framer: `<motion.div animate={{ rotate: 360 }} transition={{ duration: 25, repeat: Infinity }} />`,
    },
  },
  {
    id: "prod-ag-4",
    variantId: "variant-ag-4",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 4: Atmospheric Split */\n.aura-cloud { filter: blur(3xl); opacity: 0.7; }`,
      framer: `<motion.div animate={{ scale: [1, 1.2, 1] }} />`,
    },
  },
  {
    id: "prod-ag-5",
    variantId: "variant-ag-5",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 5: Ethereal Negative Space Float */\n.ethereal-card { background: #ffffff; border: none; }`,
      framer: `<motion.img animate={{ y: [-16, 6, -16] }} />`,
    },
  },
  {
    id: "prod-ag-6",
    variantId: "variant-ag-6",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 6: Frosted Glass Drawer */\n.frosted-drawer { backdrop-filter: blur(12px); }`,
      framer: `<motion.div animate={{ y: isHovered ? -4 : 0 }} />`,
    },
  },
  {
    id: "prod-ag-7",
    variantId: "variant-ag-7",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 7: Gravity Pulse Field */\n.magnetic-ring { border: 1px solid rgba(6,182,212,0.3); }`,
      framer: `<motion.div animate={{ scale: [1, 1.4, 1] }} />`,
    },
  },
  {
    id: "prod-ag-8",
    variantId: "variant-ag-8",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
    ...
    codeSnippet: {
      css: `/* Style 8: Holographic Prism Edge */\n.prism-border { background: linear-gradient(to right, #ec4899, #a855f7, #06b6d4); }`,
      framer: `<motion.div animate={{ rotate: [0, 360] }} />`,
    },
  },
  {
    id: "prod-ag-9",
    variantId: "variant-ag-9",
    title: "Aero-Stride Pro X",
    brand: "Apex Velocity",
    category: "Antigravity Sneakers",
    price: 189.99,
...
.orbit-path { stroke-dasharray: 3 3; }`,
  ...
  },
  {
    id: "prod-1",
    variantId: "variant-a",
    title: "Gawdee Pure A2 Bilona Desi Ghee",
    category: "Organic Dairy & Ghee",
    brand: "Gawdee",
    price: 34.99,
    originalPrice: 42.00,
    ...
    codeSnippet: {
      css: `/* Variant A: Gawdee Crossfade & Slide Actions */
.card-gawdee { position: relative; border-color: #009B7B; }`,
      framer: `<motion.img src={hovered ? product.images.secondary : product.images.primary} />`,
    },
  },
  {
    id: "prod-2",
    ...
    codeSnippet: {
      css: `/* Variant B: 3D Gawdee Perspective Tilt */
.gawdee-tilt { transform-style: preserve-3d; transition: transform 0.15s ease-out; }`,
      framer: `const rotateX = useTransform(mouseY, [-0.5, 0.5], [15, -15]);`,
    },
  },
  {
    id: "prod-3",
    variantId: "variant-c",
    title: "Gawdee Raw Organic Moringa Powder",
    ...
    codeSnippet: {
      css: `/* Variant C: Ken Burns Organic Scale & Emerald Vignette */
.card:hover .kenburns-gawdee { transform: scale(1.15); }`,
      framer: `<motion.img whileHover={{ scale: 1.15 }} />`,
    },
  },
  {
    id: "prod-4",
    ...
    codeSnippet: {
      css: `/* Variant D: Gawdee Swatch Switcher */
.swatch-gawdee.active { outline: 2px solid #009B7B; }`,
      framer: `<AnimatePresence mode="wait"><motion.img key={activeSwatch.img} src={activeSwatch.img} /></AnimatePresence>`,
    },
  },
  {
    id: "prod-5",
    variantId: "variant-e",
    title: "Gawdee Unrefined Organic Burra Sugar",
    ...
    images: {
      ...
      secondary: "/images/IMG_1439.PNG",
    },
    codeSnippet: {
      css: `/* Variant E: Gawdee Glass Drawer Slide-Up */
.card:hover .gawdee-drawer { transform: translateY(0); }`,
      framer: `<motion.div animate={{ y: isHovered ? 0 : "100%" }} />`,
    },
  },
  {
    id: "prod-6",
    ...
    codeSnippet: {
      css: `/* Variant F: Split Diagonal Clip-Path Reveal */
.card:hover .diagonal-gawdee { clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%); }`,
      framer: `<motion.div animate={{ clipPath: isHovered ? "polygon(0 0, 100% 0, 100% 100%, 0 100%)" : "polygon(100% 0, 100% 0, 100% 100%, 100% 100%)" }} />`,
    },
  },
  {
    id: "prod-7",
    variantId: "variant-g",
    title: "Gawdee Taral Drop Herbal Extract",
    ...
    codeSnippet: {
      css: `/* Variant G: Gawdee Lens Zoom Follower */
.lens-gawdee { width: 140px; height: 140px; border-radius: 50%; border: 2px solid #009B7B; }`,
      framer: `<div onMouseMove={(e) => updateLensPosition(e)} />`,
    },
  },
  {
    id: "prod-8",
    variantId: "variant-h",
    title: "Gawdee Organic Wellness Health Pack",
    ...
    codeSnippet: {
      css: `/* Variant H: Gawdee Emerald Holographic Glow */
.gawdee-holo { border-image: linear-gradient(to right, #009B7B, #34d399) 1; }`,
      framer: `<motion.div whileHover={{ boxShadow: "0 0 40px rgba(0, 155, 123, 0.5)" }} />`,
    },
  },
  {
    id: "prod-9",
    variantId: "variant-i",
    title: "Gawdee Vedic A2 Ghee Heritage Crock",
    category: "Organic Dairy & Ghee",
    brand: "Gawdee",
    price: 59.99,
    originalPrice: 75.00,
    ...
    codeSnippet: {
      css: `/* Variant I: 3D Double-Sided Card Flip */
.card-flip { transform-style: preserve-3d; transition: transform 0.6s ease; }`,
      framer: `<motion.div animate={{ rotateY: isFlipped ? 180 : 0 }} />`,
    },
  },
  {
    id: "prod-10",
    ...
    codeSnippet: {
      css: `/* Variant J: Split Venetian Curtain Reveal */
.card:hover .left-curtain { transform: translateX(-100%); }`,
      framer: `<motion.div animate={{ x: isHovered ? "-100%" : "0%" }} />`,
    },
  },
  {
    id: "prod-11",
    variantId: "variant-k",
    title: "Gawdee Organic Grand Harvest Collection",
    category: "Luxury Organic Packs",
    brand: "Gawdee",
    price: 89.99,
    ...
    codeSnippet: {
      css: `/* Variant K: Wide Landscape Banner Layout */
.card-landscape { grid-column: span 2 / span 2; }`,
      framer: `<motion.img animate={{ scale: isHovered ? 1.1 : 1 }} />`,
    },
  },
  {
    id: "prod-12",
    ...
    codeSnippet: {
      css: `/* Variant L: Floating Glass Morph & Ripple Pulse */
@keyframes pulseAura { 0% { transform: scale(1); } 100% { transform: scale(1.05); } }`,
      framer: `<motion.div animate={{ scale: isHovered ? [1, 1.03, 1] : 1 }} />`,
    },
  },
  {
    id: "prod-13",
    ...
    codeSnippet: {
      css: `/* Variant M: Spatial UI Apple Vision Float */
.spatial-layer { transform: translateZ(50px); }`,
      framer: `<motion.div style={{ rotateX, rotateY, transformStyle: "preserve-3d" }} />`,
    },
  },
  {
    id: "prod-14",
    ...
    codeSnippet: {
      css: `/* Variant N: 3D Turntable Spinner */
.stage:hover .product-spin { animation: spin3D 4s linear infinite; }`,
      framer: `<motion.div animate={{ rotateY: isHovered ? [0, 360] : 0 }} />`,
    },
  },
  {
    id: "prod-15",
    ...
    codeSnippet: {
      css: `/* Variant O: Directional Light & Dynamic Shadow */
.card-shadow { box-shadow: var(--shadow-x) var(--shadow-y) 30px rgba(0, 155, 123, 0.3); }`,
      framer: `<div style={{ boxShadow: \`\${shadowX}px \${shadowY}px 30px rgba(0,155,123,0.3)\` }} />`,
    },
  },
  {
    id: "prod-16",
    variantId: "variant-p",
    title: "Gawdee Laser Scan Khandsari Sugar",
    category: "Natural Sweeteners",
    brand: "Gawdee",
    price: 15.99,
    originalPrice: 20.00,
    ...
    codeSnippet: {
      css: `/* Variant P: Laser Scanner Beam Sweep */
@keyframes laserScan { 0% { top: 0%; } 100% { top: 100%; } }`,
      framer: `<motion.div animate={{ top: ["0%", "100%", "0%"] }} transition={{ duration: 2, repeat: Infinity }} />`,
    },
  },
  {
    id: "prod-17",
    ...
    codeSnippet: {
      css: `/* Variant Q: Inline Multi-Tab Switcher Card */
.tab-btn.active { border-bottom: 2px solid #009B7B; color: #009B7B; }`,
      framer: `<AnimatePresence mode="wait"><motion.div key={activeTab} animate={{ opacity: 1, y: 0 }} /></AnimatePresence>`,
    },
  },
  {
    id: "prod-18",
    variantId: "variant-r",
    title: "Gawdee Liquid Wave Taral Extract",
    category: "Concentrated Extracts",
    brand: "Gawdee",
    price: 31.99,
    originalPrice: 40.00,
    ...
    codeSnippet: {
      css: `/* Variant R: Liquid Ripple Wave Glass Morph */
.ripple-ring { animation: rippleExpand 1.6s ease-out infinite; }`,
      framer: `<motion.div animate={{ width: ["0px", "400px"], opacity: [0.8, 0] }} transition={{ duration: 1.6, repeat: Infinity }} />`,
    },
  },
  {
    id: "prod-19",
    variantId: "variant-s",
    title: "Gawdee Pure A2 Ghee Live Harvest Stream",
    category: "Organic Dairy & Ghee",
    brand: "Gawdee",
    price: 39.99,
    originalPrice: 48.00,
    ...
    codeSnippet: {
      css: `/* Variant S: 3D Continuous Autoplay Video Stage */
.video-card { transform-style: preserve-3d; border-color: #10b981; }`,
      framer: `<video src="/videos/video-erasio.mp4" autoPlay loop muted playsInline />`,
    },
  },
  {
    id: "prod-20",
    ...
    codeSnippet: {
      css: `/* Variant T: Hover Autoplay Video Reveal */
.poster-img { opacity: 1; transition: opacity 0.5s ease; }`,
      framer: `<video src="/videos/An_animated_changing_video_gen.mp4" loop muted />`,
    },
  },
  {
    id: "prod-21",
    ...
    codeSnippet: {
      css: `/* Variant U: Cinematic 3D Glass Portal Video Card */
.glass-portal { border: 4px solid rgba(45, 212, 191, 0.3); border-radius: 1.5rem; }`,
      framer: `<video src="/videos/video-erasio_iSSRdfb7.mp4" autoPlay loop muted />`,
    },
  },
  {
    id: "prod-22",
    ...
    codeSnippet: {
      css: `/* Variant V: Spatial 3D Parallax Video Stage */
.parallax-bg { opacity: 0.7; transform: translateZ(0); }`,
      framer: `<motion.img style={{ transform: "translateZ(40px)" }} />`,
    },
  },
];
